...
/*   Updated: 2025/03/19 09:21:53 by antauber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if(cube->map.map[(int)(cube->ray.pos_y)][(int)(cube->ray.pos_x + cube->ray.dir_x * MOVE_SPEED * dir)] != '1')
		cube->ray.pos_x += cube->ray.dir_x * MOVE_SPEED * dir;
	if(cube->map.map[(int)(cube->ray.pos_y + cube->ray.dir_y * MOVE_SPEED * dir)][(int)(cube->ray.pos_x)] != '1')
